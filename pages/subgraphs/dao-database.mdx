...
The Record Entity in our subgraphs are what we call the DAO database. These allow DAOs to create content that is indexed in the subgraphs and eliminates the need for off-chain database storage.
