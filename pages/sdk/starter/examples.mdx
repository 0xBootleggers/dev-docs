...
- [Deployment](https://silo.haus/rdf/)
- [Github](https://github.com/SiloHaus)

![silo-rdf](https://github.com/HausDAO/monorepo/assets/522182/8f1fe65f-e2dd-4b93-804a-2692fd734db1)
...
The NetworkRegistry contracts aim to help [Protocol Guild](https://protocol-guild.readthedocs.io/en/latest/) maintain a cross-chain-chain registry of active community contributors which is updated periodically to track members activity and update the compensation distribution. It uses [Connext](https://www.connext.network/) to maintain the member registry state across multiple chains and integrates with [0xSplits](https://splits.org/) for split vested funds.

- [Github](https://github.com/HausDAO/protocol-guildß)
...
- [Deployment](https://cookie-jar-alpha.vercel.app/)
- [Github](https://github.com/bitbeckers/cookiejar-contracts)

![cookie-jar](https://github.com/HausDAO/monorepo/assets/522182/461bf72c-6716-4f68-93bd-2e4b49903e1e)
