...
The Moloch v3 Hooks package is a collection of React hooks you can use fetch and store data to use in components anywhere in your application, like:

- Current DAO data (including proposals, members, safes, and DAO records)
- Current connected address membership data
- ERC-20 data

## [View on Github](https://github.com/HausDAO/monorepo/tree/develop/libs/moloch-v3-hooks)
...
### [ERC20](https://github.com/HausDAO/monorepo/blob/develop/libs/moloch-v3-hooks/src/hooks/useConnectedMember.tsx)
